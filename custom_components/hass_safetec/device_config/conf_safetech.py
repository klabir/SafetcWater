...
MICROLEAKAGE_SCHEDULE_CODES = {"1": "daily", "2": "weekly", "3": "monthly"}
...
SERVICES = {
    ...
    "microleakage_test": {"name": "Start microleakage test", "endpoint": "set/dex"},
    "microleakage_time": {
...
SELECTORS = {
    "profile_select": {"name": "Profile", "type": "profile_select"},
    "microleakage_schedule": {
